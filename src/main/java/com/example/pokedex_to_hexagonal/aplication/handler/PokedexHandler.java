...
import com.example.pokedex_to_hexagonal.aplication.mapper.PokedexRequestMapper;
import com.example.pokedex_to_hexagonal.aplication.mapper.PokedexResponseMapper;
import com.example.pokedex_to_hexagonal.aplication.mapper.TypeDtoMapper;
...
public class PokedexHandler implements IPokedexHandler {
    ...
    public List<PokedexResponse> getAllPokemonFromPokedex() {
        return pokedexResponseMapper.toResponseList(pokemonServicePort.getAllPokemons(), typeServicePort.getAllTypes(), photoServicePort.getAllPhotos());
    }
